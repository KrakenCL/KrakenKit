...
extension Xla_PrimitiveType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Xla_PrimitiveType] = [
    .invalid,
    .pred,
    .s8,
    .s16,
...
extension Xla_Format: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Xla_Format] = [
    .invalidFormat,
    .dense,
    .sparse,
  ]
...
extension Xla_FftType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Xla_FftType] = [
    .fft,
    .ifft,
    .rfft,
    .irfft,
...
extension Xla_RandomDistribution: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Xla_RandomDistribution] = [
    .rngInvalid,
    .rngUniform,
    .rngNormal,
  ]
...
public struct Xla_LayoutProto {
  ...
  /// error.
  public var tiles: [Xla_TileProto] = []
  ...
  public var elementSizeInBits: Int64 = 0
...
public struct Xla_ShapeProto {
  ...
  public var tupleShapes: [Xla_ShapeProto] {
    get {return _storage._tupleShapes}
    set {_uniqueStorage()._tupleShapes = newValue}
  }

  /// The layout used to back this shape.
  public var layout: Xla_LayoutProto {
    get {return _storage._layout ?? Xla_LayoutProto()}
  ...
  public var isDynamicDimension: [Bool] {
    get {return _storage._isDynamicDimension}
    set {_uniqueStorage()._isDynamicDimension = newValue}
  }
...
/// function signature).
public struct Xla_ProgramShapeProto {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var parameters: [Xla_ShapeProto] {
    get {return _storage._parameters}
    set {_uniqueStorage()._parameters = newValue}
  }

  public var result: Xla_ShapeProto {
    get {return _storage._result ?? Xla_ShapeProto()}
...
public struct Xla_ChannelHandle {
  ...
  public var type: Xla_ChannelHandle.ChannelType = .invalid
  ...
  public enum ChannelType: SwiftProtobuf.Enum {
    ...
    public init?(rawValue: Int) {
      switch rawValue {
      case 0: self = .invalid
      case 1: self = .deviceToDevice
      case 2: self = .deviceToHost
      case 3: self = .hostToDevice
      default: self = .UNRECOGNIZED(rawValue)
      }
    }
    ...
    public var rawValue: Int {
      switch self {
      case .invalid: return 0
      case .deviceToDevice: return 1
      case .deviceToHost: return 2
      case .hostToDevice: return 3
      case .UNRECOGNIZED(let i): return i
      }
    }
...
extension Xla_ChannelHandle.ChannelType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Xla_ChannelHandle.ChannelType] = [
    .invalid,
    .deviceToDevice,
    .deviceToHost,
    .hostToDevice,
...
public struct Xla_LiteralProto {
  ...
  public var s8S: Data {
    get {return _storage._s8S}
    set {_uniqueStorage()._s8S = newValue}
  }
  ...
  public var c128S: [Double] {
    get {return _storage._c128S}
    set {_uniqueStorage()._c128S = newValue}
  }
  ...
  public var u16S: Data {
    get {return _storage._u16S}
    set {_uniqueStorage()._u16S = newValue}
  }

  public var s16S: Data {
    get {return _storage._s16S}
    set {_uniqueStorage()._s16S = newValue}
  }
...
public struct Xla_GatherDimensionNumbers {
  ...
  public var offsetDims: [Int64] = []

  public var collapsedSliceDims: [Int64] = []
  ...
  public var startIndexMap: [Int64] = []
...
public struct Xla_ScatterDimensionNumbers {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The set of dimensions in the updates shape that are window dimensions.
  public var updateWindowDims: [Int64] = []

  /// The set of window dimensions that must be inserted into the updates shape.
  public var insertedWindowDims: [Int64] = []

  public var scatterDimsToOperandDims: [Int64] = []
...
public struct Xla_OpSharding {
  ...
  public var tileShape: Xla_ShapeProto {
    get {return _storage._tileShape ?? Xla_ShapeProto()}
  ...
  public mutating func clearTileShape() {_uniqueStorage()._tileShape = nil}
...
extension Xla_OpSharding.TypeEnum: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Xla_OpSharding.TypeEnum] = [
    .replicated,
    .maximal,
    .tuple,
    .other,
...
/// all-to-all).
public struct Xla_ReplicaGroup {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Xla_SourceTarget {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// meaning.
public struct Xla_PrecisionConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var operandPrecision: [Xla_PrecisionConfig.Precision] = []

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public enum Precision: SwiftProtobuf.Enum {
    public typealias RawValue = Int
    case `default` // = 0
    case high // = 1
    case highest // = 2
...
extension Xla_PrecisionConfig.Precision: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Xla_PrecisionConfig.Precision] = [
    .default,
    .high,
    .highest,
  ]
...
extension Xla_PaddingConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Xla_PaddingConfig, rhs: Xla_PaddingConfig) -> Bool {
...
extension Xla_PaddingConfig.PaddingConfigDimension: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Xla_PaddingConfig.PaddingConfigDimension, rhs: Xla_PaddingConfig.PaddingConfigDimension) -> Bool {
    if lhs.edgePaddingLow != rhs.edgePaddingLow {return false}
    if lhs.edgePaddingHigh != rhs.edgePaddingHigh {return false}
    if lhs.interiorPadding != rhs.interiorPadding {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Xla_TileProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".TileProto"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "dimensions"),
  ]
  ...
  public static func ==(lhs: Xla_TileProto, rhs: Xla_TileProto) -> Bool {
    if lhs.dimensions != rhs.dimensions {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Xla_LayoutProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".LayoutProto"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    4: .same(proto: "format"),
    1: .standard(proto: "minor_to_major"),
    5: .standard(proto: "max_sparse_elements"),
    6: .same(proto: "tiles"),
    7: .standard(proto: "element_size_in_bits"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 6: try decoder.decodeRepeatedMessageField(value: &self.tiles)
      case 7: try decoder.decodeSingularInt64Field(value: &self.elementSizeInBits)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.tiles.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.tiles, fieldNumber: 6)
    }
    if self.elementSizeInBits != 0 {
      try visitor.visitSingularInt64Field(value: self.elementSizeInBits, fieldNumber: 7)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Xla_LayoutProto, rhs: Xla_LayoutProto) -> Bool {
    if lhs.format != rhs.format {return false}
    if lhs.minorToMajor != rhs.minorToMajor {return false}
    if lhs.maxSparseElements != rhs.maxSparseElements {return false}
    if lhs.tiles != rhs.tiles {return false}
    if lhs.elementSizeInBits != rhs.elementSizeInBits {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Xla_ShapeProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ShapeProto"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    2: .standard(proto: "element_type"),
    3: .same(proto: "dimensions"),
    4: .standard(proto: "tuple_shapes"),
    5: .same(proto: "layout"),
    6: .standard(proto: "is_dynamic_dimension"),
  ]

  fileprivate class _StorageClass {
    var _elementType: Xla_PrimitiveType = .invalid
    var _dimensions: [Int64] = []
    var _tupleShapes: [Xla_ShapeProto] = []
    var _layout: Xla_LayoutProto? = nil
    var _isDynamicDimension: [Bool] = []
    ...
    init(copying source: _StorageClass) {
      ...
      _isDynamicDimension = source._isDynamicDimension
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 6: try decoder.decodeRepeatedBoolField(value: &_storage._isDynamicDimension)
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._isDynamicDimension.isEmpty {
        try visitor.visitPackedBoolField(value: _storage._isDynamicDimension, fieldNumber: 6)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Xla_ShapeProto, rhs: Xla_ShapeProto) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._tupleShapes != rhs_storage._tupleShapes {return false}
        if _storage._layout != rhs_storage._layout {return false}
        if _storage._isDynamicDimension != rhs_storage._isDynamicDimension {return false}
        return true
      }
...
extension Xla_ProgramShapeProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ProgramShapeProto"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  fileprivate class _StorageClass {
    var _parameters: [Xla_ShapeProto] = []
    var _result: Xla_ShapeProto? = nil
  ...
  public static func ==(lhs: Xla_ProgramShapeProto, rhs: Xla_ProgramShapeProto) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        ...
        if _storage._parameterNames != rhs_storage._parameterNames {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension Xla_ComputationStats: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Xla_ComputationStats, rhs: Xla_ComputationStats) -> Bool {
    if lhs.flopCount != rhs.flopCount {return false}
    if lhs.transcendentalCount != rhs.transcendentalCount {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Xla_OpMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Xla_OpMetadata, rhs: Xla_OpMetadata) -> Bool {
...
extension Xla_ExecutionProfile: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Xla_ExecutionProfile, rhs: Xla_ExecutionProfile) -> Bool {
    if lhs.compilationCacheHit != rhs.compilationCacheHit {return false}
    if lhs.compileTimeMs != rhs.compileTimeMs {return false}
    if lhs.computeCycleCount != rhs.computeCycleCount {return false}
    if lhs.computeTimeNs != rhs.computeTimeNs {return false}
    if lhs.computeAndTransferTimeNs != rhs.computeAndTransferTimeNs {return false}
    if lhs.executableSizeInBytes != rhs.executableSizeInBytes {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Xla_ExecutionHandle: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Xla_ExecutionHandle, rhs: Xla_ExecutionHandle) -> Bool {
...
extension Xla_GlobalDataHandle: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Xla_GlobalDataHandle, rhs: Xla_GlobalDataHandle) -> Bool {
    if lhs.handle != rhs.handle {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Xla_DeviceHandle: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Xla_DeviceHandle, rhs: Xla_DeviceHandle) -> Bool {
    if lhs.handle != rhs.handle {return false}
...
extension Xla_ChannelHandle: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Xla_ChannelHandle, rhs: Xla_ChannelHandle) -> Bool {
    if lhs.handle != rhs.handle {return false}
...
extension Xla_ChannelHandle.ChannelType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "CHANNEL_TYPE_INVALID"),
    1: .same(proto: "DEVICE_TO_DEVICE"),
    2: .same(proto: "DEVICE_TO_HOST"),
    3: .same(proto: "HOST_TO_DEVICE"),
  ]
}
...
extension Xla_DeviceAssignmentProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Xla_DeviceAssignmentProto, rhs: Xla_DeviceAssignmentProto) -> Bool {
    if lhs.replicaCount != rhs.replicaCount {return false}
    if lhs.computationCount != rhs.computationCount {return false}
...
extension Xla_DeviceAssignmentProto.ComputationDevice: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Xla_DeviceAssignmentProto.ComputationDevice, rhs: Xla_DeviceAssignmentProto.ComputationDevice) -> Bool {
    if lhs.replicaDeviceIds != rhs.replicaDeviceIds {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Xla_LiteralProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _preds: [Bool] = []
    var _s8S: Data = SwiftProtobuf.Internal.emptyData
    ...
    var _u16S: Data = SwiftProtobuf.Internal.emptyData
    var _s16S: Data = SwiftProtobuf.Internal.emptyData
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 15: try decoder.decodeSingularBytesField(value: &_storage._s8S)
        case 16: try decoder.decodeSingularBytesField(value: &_storage._u16S)
        case 17: try decoder.decodeSingularBytesField(value: &_storage._s16S)
        case 18: try decoder.decodeRepeatedDoubleField(value: &_storage._c128S)
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._s8S.isEmpty {
        try visitor.visitSingularBytesField(value: _storage._s8S, fieldNumber: 15)
      }
      if !_storage._u16S.isEmpty {
        try visitor.visitSingularBytesField(value: _storage._u16S, fieldNumber: 16)
      }
      if !_storage._s16S.isEmpty {
        try visitor.visitSingularBytesField(value: _storage._s16S, fieldNumber: 17)
      }
      if !_storage._c128S.isEmpty {
        try visitor.visitPackedDoubleField(value: _storage._c128S, fieldNumber: 18)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Xla_LiteralProto, rhs: Xla_LiteralProto) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._shape != rhs_storage._shape {return false}
        if _storage._preds != rhs_storage._preds {return false}
        if _storage._s8S != rhs_storage._s8S {return false}
        if _storage._u8S != rhs_storage._u8S {return false}
        if _storage._s32S != rhs_storage._s32S {return false}
        if _storage._s64S != rhs_storage._s64S {return false}
        if _storage._u32S != rhs_storage._u32S {return false}
        if _storage._u64S != rhs_storage._u64S {return false}
        if _storage._f32S != rhs_storage._f32S {return false}
        if _storage._f64S != rhs_storage._f64S {return false}
        if _storage._c64S != rhs_storage._c64S {return false}
        if _storage._c128S != rhs_storage._c128S {return false}
        if _storage._tupleLiterals != rhs_storage._tupleLiterals {return false}
        if _storage._f16S != rhs_storage._f16S {return false}
        if _storage._bf16S != rhs_storage._bf16S {return false}
        if _storage._u16S != rhs_storage._u16S {return false}
        if _storage._s16S != rhs_storage._s16S {return false}
...
extension Xla_WindowDimension: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Xla_WindowDimension, rhs: Xla_WindowDimension) -> Bool {
    if lhs.size != rhs.size {return false}
    if lhs.stride != rhs.stride {return false}
    if lhs.paddingLow != rhs.paddingLow {return false}
    if lhs.paddingHigh != rhs.paddingHigh {return false}
    if lhs.windowDilation != rhs.windowDilation {return false}
    if lhs.baseDilation != rhs.baseDilation {return false}
    if lhs.windowReversal != rhs.windowReversal {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Xla_Window: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Xla_Window, rhs: Xla_Window) -> Bool {
    if lhs.dimensions != rhs.dimensions {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Xla_GatherDimensionNumbers: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "offset_dims"),
    2: .standard(proto: "collapsed_slice_dims"),
    3: .standard(proto: "start_index_map"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeRepeatedInt64Field(value: &self.offsetDims)
      case 2: try decoder.decodeRepeatedInt64Field(value: &self.collapsedSliceDims)
      case 3: try decoder.decodeRepeatedInt64Field(value: &self.startIndexMap)
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.offsetDims.isEmpty {
      try visitor.visitPackedInt64Field(value: self.offsetDims, fieldNumber: 1)
    }
    if !self.collapsedSliceDims.isEmpty {
      try visitor.visitPackedInt64Field(value: self.collapsedSliceDims, fieldNumber: 2)
    }
    if !self.startIndexMap.isEmpty {
      try visitor.visitPackedInt64Field(value: self.startIndexMap, fieldNumber: 3)
    }
  ...
  public static func ==(lhs: Xla_GatherDimensionNumbers, rhs: Xla_GatherDimensionNumbers) -> Bool {
    if lhs.offsetDims != rhs.offsetDims {return false}
    if lhs.collapsedSliceDims != rhs.collapsedSliceDims {return false}
    if lhs.startIndexMap != rhs.startIndexMap {return false}
    if lhs.indexVectorDim != rhs.indexVectorDim {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Xla_ScatterDimensionNumbers: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ScatterDimensionNumbers"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "update_window_dims"),
    2: .standard(proto: "inserted_window_dims"),
    3: .standard(proto: "scatter_dims_to_operand_dims"),
    4: .standard(proto: "index_vector_dim"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeRepeatedInt64Field(value: &self.updateWindowDims)
      case 2: try decoder.decodeRepeatedInt64Field(value: &self.insertedWindowDims)
      case 3: try decoder.decodeRepeatedInt64Field(value: &self.scatterDimsToOperandDims)
      case 4: try decoder.decodeSingularInt64Field(value: &self.indexVectorDim)
      default: break
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.updateWindowDims.isEmpty {
      try visitor.visitPackedInt64Field(value: self.updateWindowDims, fieldNumber: 1)
    }
    if !self.insertedWindowDims.isEmpty {
      try visitor.visitPackedInt64Field(value: self.insertedWindowDims, fieldNumber: 2)
    }
    if !self.scatterDimsToOperandDims.isEmpty {
      try visitor.visitPackedInt64Field(value: self.scatterDimsToOperandDims, fieldNumber: 3)
    }
    if self.indexVectorDim != 0 {
      try visitor.visitSingularInt64Field(value: self.indexVectorDim, fieldNumber: 4)
    }
  ...
  public static func ==(lhs: Xla_ScatterDimensionNumbers, rhs: Xla_ScatterDimensionNumbers) -> Bool {
    if lhs.updateWindowDims != rhs.updateWindowDims {return false}
    if lhs.insertedWindowDims != rhs.insertedWindowDims {return false}
    if lhs.scatterDimsToOperandDims != rhs.scatterDimsToOperandDims {return false}
    if lhs.indexVectorDim != rhs.indexVectorDim {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Xla_ConvolutionDimensionNumbers: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Xla_ConvolutionDimensionNumbers, rhs: Xla_ConvolutionDimensionNumbers) -> Bool {
    if lhs.inputBatchDimension != rhs.inputBatchDimension {return false}
    if lhs.inputFeatureDimension != rhs.inputFeatureDimension {return false}
    if lhs.inputSpatialDimensions != rhs.inputSpatialDimensions {return false}
    if lhs.kernelInputFeatureDimension != rhs.kernelInputFeatureDimension {return false}
    if lhs.kernelOutputFeatureDimension != rhs.kernelOutputFeatureDimension {return false}
    if lhs.kernelSpatialDimensions != rhs.kernelSpatialDimensions {return false}
    if lhs.outputBatchDimension != rhs.outputBatchDimension {return false}
    if lhs.outputFeatureDimension != rhs.outputFeatureDimension {return false}
    if lhs.outputSpatialDimensions != rhs.outputSpatialDimensions {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Xla_DotDimensionNumbers: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Xla_DotDimensionNumbers, rhs: Xla_DotDimensionNumbers) -> Bool {
    if lhs.lhsContractingDimensions != rhs.lhsContractingDimensions {return false}
    if lhs.rhsContractingDimensions != rhs.rhsContractingDimensions {return false}
    if lhs.lhsBatchDimensions != rhs.lhsBatchDimensions {return false}
    if lhs.rhsBatchDimensions != rhs.rhsBatchDimensions {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Xla_OpSharding: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _tileShape: Xla_ShapeProto? = nil
  ...
  public static func ==(lhs: Xla_OpSharding, rhs: Xla_OpSharding) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._type != rhs_storage._type {return false}
        if _storage._tileShape != rhs_storage._tileShape {return false}
        if _storage._tileAssignmentDimensions != rhs_storage._tileAssignmentDimensions {return false}
        if _storage._tileAssignmentDevices != rhs_storage._tileAssignmentDevices {return false}
        if _storage._tupleShardings != rhs_storage._tupleShardings {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension Xla_ReplicaGroup: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ReplicaGroup"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "replica_ids"),
  ]

  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeRepeatedInt64Field(value: &self.replicaIds)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.replicaIds.isEmpty {
      try visitor.visitPackedInt64Field(value: self.replicaIds, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Xla_ReplicaGroup, rhs: Xla_ReplicaGroup) -> Bool {
    if lhs.replicaIds != rhs.replicaIds {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Xla_SourceTarget: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SourceTarget"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "source"),
    2: .same(proto: "target"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularInt64Field(value: &self.source)
      case 2: try decoder.decodeSingularInt64Field(value: &self.target)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if self.source != 0 {
      try visitor.visitSingularInt64Field(value: self.source, fieldNumber: 1)
    }
    if self.target != 0 {
  ...
  public static func ==(lhs: Xla_SourceTarget, rhs: Xla_SourceTarget) -> Bool {
...
extension Xla_PrecisionConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PrecisionConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "operand_precision"),
  ]

  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeRepeatedEnumField(value: &self.operandPrecision)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.operandPrecision.isEmpty {
      try visitor.visitPackedEnumField(value: self.operandPrecision, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Xla_PrecisionConfig, rhs: Xla_PrecisionConfig) -> Bool {
    if lhs.operandPrecision != rhs.operandPrecision {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Xla_PrecisionConfig.Precision: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "DEFAULT"),
    1: .same(proto: "HIGH"),
    2: .same(proto: "HIGHEST"),
  ]
}
