...
public struct Xla_HloProfilePrinterData {
  ...
  public var extraMetrics: Dictionary<String,Int64> = [:]

  /// Name of the entry computation.
  public var entryComputation: String = String()
...
extension Xla_HloProfilePrinterData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    3: .standard(proto: "extra_metrics"),
    4: .standard(proto: "entry_computation"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufString,SwiftProtobuf.ProtobufInt64>.self, value: &self.extraMetrics)
      case 4: try decoder.decodeSingularStringField(value: &self.entryComputation)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.extraMetrics.isEmpty {
      try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufString,SwiftProtobuf.ProtobufInt64>.self, value: self.extraMetrics, fieldNumber: 3)
    }
    if !self.entryComputation.isEmpty {
      try visitor.visitSingularStringField(value: self.entryComputation, fieldNumber: 4)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Xla_HloProfilePrinterData, rhs: Xla_HloProfilePrinterData) -> Bool {
    if lhs.computationInfos != rhs.computationInfos {return false}
    if lhs.profileCountersSize != rhs.profileCountersSize {return false}
    if lhs.extraMetrics != rhs.extraMetrics {return false}
    if lhs.entryComputation != rhs.entryComputation {return false}
...
extension Xla_HloProfilePrinterData.HloInstructionInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Xla_HloProfilePrinterData.HloInstructionInfo, rhs: Xla_HloProfilePrinterData.HloInstructionInfo) -> Bool {
    ...
    if lhs.bytesAccessed != rhs.bytesAccessed {return false}
    if lhs.optimalSeconds != rhs.optimalSeconds {return false}
    if lhs.profileIndex != rhs.profileIndex {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Xla_HloProfilePrinterData.HloComputationInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Xla_HloProfilePrinterData.HloComputationInfo, rhs: Xla_HloProfilePrinterData.HloComputationInfo) -> Bool {
    if lhs.name != rhs.name {return false}
    if lhs.profileIndex != rhs.profileIndex {return false}
    if lhs.instructionInfos != rhs.instructionInfos {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
