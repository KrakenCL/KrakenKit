...
public struct Tensorflow_CppShapeInferenceResult {
  ...
  public mutating func clearHandleData() {_uniqueStorage()._handleData = nil}
...
extension Tensorflow_CppShapeInferenceResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_CppShapeInferenceResult, rhs: Tensorflow_CppShapeInferenceResult) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._shape != rhs_storage._shape {return false}
        if _storage._handleData != rhs_storage._handleData {return false}
        return true
      }
...
extension Tensorflow_CppShapeInferenceResult.HandleShapeAndType: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_CppShapeInferenceResult.HandleShapeAndType, rhs: Tensorflow_CppShapeInferenceResult.HandleShapeAndType) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Tensorflow_CppShapeInferenceResult.HandleData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_CppShapeInferenceResult.HandleData, rhs: Tensorflow_CppShapeInferenceResult.HandleData) -> Bool {
...
extension Tensorflow_CppShapeInferenceInputsNeeded: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_CppShapeInferenceInputsNeeded, rhs: Tensorflow_CppShapeInferenceInputsNeeded) -> Bool {
