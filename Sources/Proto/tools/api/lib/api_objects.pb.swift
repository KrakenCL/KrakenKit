...
public struct ThirdParty_Tensorflow_Tools_Api_TFAPIObject {
  ...
  public mutating func clearTfModule() {_uniqueStorage()._tfModule = nil}
  ...
  public mutating func clearTfClass() {_uniqueStorage()._tfClass = nil}
  ...
  public mutating func clearTfProto() {_uniqueStorage()._tfProto = nil}
...
extension ThirdParty_Tensorflow_Tools_Api_TFAPIMember: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: ThirdParty_Tensorflow_Tools_Api_TFAPIMember, rhs: ThirdParty_Tensorflow_Tools_Api_TFAPIMember) -> Bool {
...
extension ThirdParty_Tensorflow_Tools_Api_TFAPIMethod: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: ThirdParty_Tensorflow_Tools_Api_TFAPIMethod, rhs: ThirdParty_Tensorflow_Tools_Api_TFAPIMethod) -> Bool {
    if lhs._name != rhs._name {return false}
    if lhs._path != rhs._path {return false}
    if lhs._argspec != rhs._argspec {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension ThirdParty_Tensorflow_Tools_Api_TFAPIModule: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: ThirdParty_Tensorflow_Tools_Api_TFAPIModule, rhs: ThirdParty_Tensorflow_Tools_Api_TFAPIModule) -> Bool {
    if lhs.member != rhs.member {return false}
    if lhs.memberMethod != rhs.memberMethod {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension ThirdParty_Tensorflow_Tools_Api_TFAPIClass: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: ThirdParty_Tensorflow_Tools_Api_TFAPIClass, rhs: ThirdParty_Tensorflow_Tools_Api_TFAPIClass) -> Bool {
    if lhs.isInstance != rhs.isInstance {return false}
    if lhs.member != rhs.member {return false}
    if lhs.memberMethod != rhs.memberMethod {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension ThirdParty_Tensorflow_Tools_Api_TFAPIProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: ThirdParty_Tensorflow_Tools_Api_TFAPIProto, rhs: ThirdParty_Tensorflow_Tools_Api_TFAPIProto) -> Bool {
...
extension ThirdParty_Tensorflow_Tools_Api_TFAPIObject: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: ThirdParty_Tensorflow_Tools_Api_TFAPIObject, rhs: ThirdParty_Tensorflow_Tools_Api_TFAPIObject) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._path != rhs_storage._path {return false}
        if _storage._tfModule != rhs_storage._tfModule {return false}
        if _storage._tfClass != rhs_storage._tfClass {return false}
        if _storage._tfProto != rhs_storage._tfProto {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
