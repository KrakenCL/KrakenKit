...
public struct Tensorflow_CallTraceback {
  ...
  public mutating func clearOriginStack() {_uniqueStorage()._originStack = nil}
  ...
  public mutating func clearGraphTraceback() {_uniqueStorage()._graphTraceback = nil}
...
extension Tensorflow_CallTraceback.CallType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Tensorflow_CallTraceback.CallType] = [
    .unspecified,
    .graphExecution,
    .eagerExecution,
  ]
...
extension Tensorflow_EventReply: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_EventReply, rhs: Tensorflow_EventReply) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._debugOpStateChanges != rhs_storage._debugOpStateChanges {return false}
...
extension Tensorflow_EventReply.DebugOpStateChange: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_EventReply.DebugOpStateChange, rhs: Tensorflow_EventReply.DebugOpStateChange) -> Bool {
    if lhs.state != rhs.state {return false}
    if lhs.nodeName != rhs.nodeName {return false}
    if lhs.outputSlot != rhs.outputSlot {return false}
    if lhs.debugOp != rhs.debugOp {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Tensorflow_CallTraceback: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_CallTraceback, rhs: Tensorflow_CallTraceback) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._callType != rhs_storage._callType {return false}
        if _storage._callKey != rhs_storage._callKey {return false}
        if _storage._originStack != rhs_storage._originStack {return false}
        if _storage._originIDToString != rhs_storage._originIDToString {return false}
        if _storage._graphTraceback != rhs_storage._graphTraceback {return false}
        if _storage._graphVersion != rhs_storage._graphVersion {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
