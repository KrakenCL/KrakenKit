...
public struct Tensorflow_Tfprof_TFProfTensorProto {
...
public struct Tensorflow_Tfprof_GraphNodeProto {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public mutating func clearTensorValue() {_uniqueStorage()._tensorValue = nil}
...
public struct Tensorflow_Tfprof_MultiGraphNodeProto {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tensorflow_Tfprof_AdviceProto {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Tensorflow_Tfprof_TFProfTensorProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Tfprof_TFProfTensorProto, rhs: Tensorflow_Tfprof_TFProfTensorProto) -> Bool {
    if lhs.dtype != rhs.dtype {return false}
    if lhs.valueDouble != rhs.valueDouble {return false}
    if lhs.valueInt64 != rhs.valueInt64 {return false}
...
extension Tensorflow_Tfprof_GraphNodeProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Tfprof_GraphNodeProto, rhs: Tensorflow_Tfprof_GraphNodeProto) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._name != rhs_storage._name {return false}
        if _storage._tensorValue != rhs_storage._tensorValue {return false}
        if _storage._runCount != rhs_storage._runCount {return false}
        if _storage._execMicros != rhs_storage._execMicros {return false}
        if _storage._acceleratorExecMicros != rhs_storage._acceleratorExecMicros {return false}
        if _storage._cpuExecMicros != rhs_storage._cpuExecMicros {return false}
        if _storage._requestedBytes != rhs_storage._requestedBytes {return false}
        if _storage._peakBytes != rhs_storage._peakBytes {return false}
        if _storage._residualBytes != rhs_storage._residualBytes {return false}
        if _storage._outputBytes != rhs_storage._outputBytes {return false}
        if _storage._parameters != rhs_storage._parameters {return false}
        if _storage._floatOps != rhs_storage._floatOps {return false}
        if _storage._devices != rhs_storage._devices {return false}
        if _storage._totalDefinitionCount != rhs_storage._totalDefinitionCount {return false}
        if _storage._totalRunCount != rhs_storage._totalRunCount {return false}
        if _storage._totalExecMicros != rhs_storage._totalExecMicros {return false}
        if _storage._totalAcceleratorExecMicros != rhs_storage._totalAcceleratorExecMicros {return false}
        if _storage._totalCpuExecMicros != rhs_storage._totalCpuExecMicros {return false}
        if _storage._totalRequestedBytes != rhs_storage._totalRequestedBytes {return false}
        if _storage._totalPeakBytes != rhs_storage._totalPeakBytes {return false}
        if _storage._totalResidualBytes != rhs_storage._totalResidualBytes {return false}
        if _storage._totalOutputBytes != rhs_storage._totalOutputBytes {return false}
        if _storage._totalParameters != rhs_storage._totalParameters {return false}
        if _storage._totalFloatOps != rhs_storage._totalFloatOps {return false}
        if _storage._shapes != rhs_storage._shapes {return false}
        if _storage._inputShapes != rhs_storage._inputShapes {return false}
...
extension Tensorflow_Tfprof_MultiGraphNodeProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Tfprof_MultiGraphNodeProto, rhs: Tensorflow_Tfprof_MultiGraphNodeProto) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        ...
        if _storage._totalParameters != rhs_storage._totalParameters {return false}
        if _storage._totalFloatOps != rhs_storage._totalFloatOps {return false}
        if _storage._graphNodes != rhs_storage._graphNodes {return false}
        if _storage._children != rhs_storage._children {return false}
        return true
      }
      if !storagesAreEqual {return false}
...
extension Tensorflow_Tfprof_AdviceProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Tfprof_AdviceProto, rhs: Tensorflow_Tfprof_AdviceProto) -> Bool {
    if lhs.checkers != rhs.checkers {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Tensorflow_Tfprof_AdviceProto.Checker: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Tfprof_AdviceProto.Checker, rhs: Tensorflow_Tfprof_AdviceProto.Checker) -> Bool {
