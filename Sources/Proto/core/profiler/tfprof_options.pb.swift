...
extension Tensorflow_Tfprof_OptionsProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Tfprof_OptionsProto, rhs: Tensorflow_Tfprof_OptionsProto) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._maxDepth != rhs_storage._maxDepth {return false}
        if _storage._minBytes != rhs_storage._minBytes {return false}
        if _storage._minPeakBytes != rhs_storage._minPeakBytes {return false}
        if _storage._minResidualBytes != rhs_storage._minResidualBytes {return false}
        if _storage._minOutputBytes != rhs_storage._minOutputBytes {return false}
        if _storage._minMicros != rhs_storage._minMicros {return false}
        if _storage._minAcceleratorMicros != rhs_storage._minAcceleratorMicros {return false}
        if _storage._minCpuMicros != rhs_storage._minCpuMicros {return false}
        if _storage._minParams != rhs_storage._minParams {return false}
        if _storage._minFloatOps != rhs_storage._minFloatOps {return false}
        if _storage._minOccurrence != rhs_storage._minOccurrence {return false}
        if _storage._step != rhs_storage._step {return false}
        if _storage._orderBy != rhs_storage._orderBy {return false}
        if _storage._accountTypeRegexes != rhs_storage._accountTypeRegexes {return false}
        if _storage._startNameRegexes != rhs_storage._startNameRegexes {return false}
        if _storage._trimNameRegexes != rhs_storage._trimNameRegexes {return false}
        if _storage._showNameRegexes != rhs_storage._showNameRegexes {return false}
        if _storage._hideNameRegexes != rhs_storage._hideNameRegexes {return false}
        if _storage._accountDisplayedOpOnly != rhs_storage._accountDisplayedOpOnly {return false}
        if _storage._select != rhs_storage._select {return false}
        if _storage._output != rhs_storage._output {return false}
        if _storage._dumpToFile != rhs_storage._dumpToFile {return false}
        return true
      }
...
extension Tensorflow_Tfprof_AdvisorOptionsProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Tfprof_AdvisorOptionsProto, rhs: Tensorflow_Tfprof_AdvisorOptionsProto) -> Bool {
...
extension Tensorflow_Tfprof_AdvisorOptionsProto.CheckerOption: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Tfprof_AdvisorOptionsProto.CheckerOption, rhs: Tensorflow_Tfprof_AdvisorOptionsProto.CheckerOption) -> Bool {
