  ...
  public static func ==(lhs: Tensorflow_OpDef, rhs: Tensorflow_OpDef) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._inputArg != rhs_storage._inputArg {return false}
        if _storage._outputArg != rhs_storage._outputArg {return false}
        ...
        if _storage._isCommutative != rhs_storage._isCommutative {return false}
        if _storage._isAggregate != rhs_storage._isAggregate {return false}
        if _storage._isStateful != rhs_storage._isStateful {return false}
        if _storage._allowsUninitializedInput != rhs_storage._allowsUninitializedInput {return false}
        return true
      }
