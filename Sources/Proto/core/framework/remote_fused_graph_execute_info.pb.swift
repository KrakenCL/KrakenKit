...
public struct Tensorflow_RemoteFusedGraphExecuteInfo {
  ...
  public mutating func clearRemoteGraph() {_uniqueStorage()._remoteGraph = nil}
...
extension Tensorflow_RemoteFusedGraphExecuteInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_RemoteFusedGraphExecuteInfo, rhs: Tensorflow_RemoteFusedGraphExecuteInfo) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._remoteGraph != rhs_storage._remoteGraph {return false}
        if _storage._graphInputNodeName != rhs_storage._graphInputNodeName {return false}
        if _storage._graphOutputNodeName != rhs_storage._graphOutputNodeName {return false}
        if _storage._executorName != rhs_storage._executorName {return false}
        if _storage._serializedExecutorParameters != rhs_storage._serializedExecutorParameters {return false}
        if _storage._defaultGraphInputTensorShape != rhs_storage._defaultGraphInputTensorShape {return false}
        if _storage._defaultGraphOutputTensorShape != rhs_storage._defaultGraphOutputTensorShape {return false}
        return true
      }
...
extension Tensorflow_RemoteFusedGraphExecuteInfo.TensorShapeTypeProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_RemoteFusedGraphExecuteInfo.TensorShapeTypeProto, rhs: Tensorflow_RemoteFusedGraphExecuteInfo.TensorShapeTypeProto) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
