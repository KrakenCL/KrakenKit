...
extension Tensorflow_InterconnectLink: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_InterconnectLink, rhs: Tensorflow_InterconnectLink) -> Bool {
...
extension Tensorflow_LocalLinks: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_LocalLinks, rhs: Tensorflow_LocalLinks) -> Bool {
...
extension Tensorflow_DeviceLocality: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_DeviceLocality, rhs: Tensorflow_DeviceLocality) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._busID != rhs_storage._busID {return false}
        if _storage._numaNode != rhs_storage._numaNode {return false}
...
extension Tensorflow_DeviceAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_DeviceAttributes, rhs: Tensorflow_DeviceAttributes) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        ...
        if _storage._memoryLimit != rhs_storage._memoryLimit {return false}
        if _storage._locality != rhs_storage._locality {return false}
        if _storage._incarnation != rhs_storage._incarnation {return false}
        if _storage._physicalDeviceDesc != rhs_storage._physicalDeviceDesc {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
