...
public struct Tensorflow_TensorDescription {
  ...
  public mutating func clearAllocationDescription() {_uniqueStorage()._allocationDescription = nil}
...
extension Tensorflow_TensorDescription: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_TensorDescription, rhs: Tensorflow_TensorDescription) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._allocationDescription != rhs_storage._allocationDescription {return false}
        return true
      }
