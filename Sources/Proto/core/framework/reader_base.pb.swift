...
public struct Tensorflow_ReaderBaseState {
...
extension Tensorflow_ReaderBaseState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_ReaderBaseState, rhs: Tensorflow_ReaderBaseState) -> Bool {
    if lhs.workStarted != rhs.workStarted {return false}
    if lhs.workFinished != rhs.workFinished {return false}
    if lhs.numRecordsProduced != rhs.numRecordsProduced {return false}
    if lhs.currentWork != rhs.currentWork {return false}
