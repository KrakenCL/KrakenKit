...
extension Tensorflow_WorkerHealth: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Tensorflow_WorkerHealth] = [
    .ok,
...
extension Tensorflow_WorkerShutdownMode: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Tensorflow_WorkerShutdownMode] = [
    .default,
    .notConfigured,
    .waitForCoordinator,
  ]
...
extension Tensorflow_LogMessage.Level: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Tensorflow_LogMessage.Level] = [
    .unknown,
    .debugging,
    .info,
    .warn,
...
extension Tensorflow_SessionLog.SessionStatus: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Tensorflow_SessionLog.SessionStatus] = [
    .statusUnspecified,
    .start,
    .stop,
    .checkpoint,
...
public struct Tensorflow_WorkerHeartbeatRequest {
  ...
  public mutating func clearWatchdogConfig() {_uniqueStorage()._watchdogConfig = nil}
...
extension Tensorflow_Event: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Event, rhs: Tensorflow_Event) -> Bool {
...
extension Tensorflow_LogMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_LogMessage, rhs: Tensorflow_LogMessage) -> Bool {
...
extension Tensorflow_SessionLog: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_SessionLog, rhs: Tensorflow_SessionLog) -> Bool {
...
extension Tensorflow_TaggedRunMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_TaggedRunMetadata, rhs: Tensorflow_TaggedRunMetadata) -> Bool {
...
extension Tensorflow_WatchdogConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_WatchdogConfig, rhs: Tensorflow_WatchdogConfig) -> Bool {
...
extension Tensorflow_WorkerHeartbeatRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_WorkerHeartbeatRequest, rhs: Tensorflow_WorkerHeartbeatRequest) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._shutdownMode != rhs_storage._shutdownMode {return false}
        if _storage._watchdogConfig != rhs_storage._watchdogConfig {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension Tensorflow_WorkerHeartbeatResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_WorkerHeartbeatResponse, rhs: Tensorflow_WorkerHeartbeatResponse) -> Bool {
