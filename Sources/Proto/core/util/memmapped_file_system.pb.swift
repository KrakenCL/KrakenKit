...
public struct Tensorflow_MemmappedFileSystemDirectoryElement {
...
public struct Tensorflow_MemmappedFileSystemDirectory {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Tensorflow_MemmappedFileSystemDirectoryElement: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_MemmappedFileSystemDirectoryElement, rhs: Tensorflow_MemmappedFileSystemDirectoryElement) -> Bool {
...
extension Tensorflow_MemmappedFileSystemDirectory: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_MemmappedFileSystemDirectory, rhs: Tensorflow_MemmappedFileSystemDirectory) -> Bool {
