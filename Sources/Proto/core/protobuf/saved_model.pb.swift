...
extension Tensorflow_SavedModel: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_SavedModel, rhs: Tensorflow_SavedModel) -> Bool {
    if lhs.savedModelSchemaVersion != rhs.savedModelSchemaVersion {return false}
    if lhs.metaGraphs != rhs.metaGraphs {return false}
