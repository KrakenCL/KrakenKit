...
extension Tensorflow_BundleHeaderProto.Endianness: CaseIterable {
  ...
  public static var allCases: [Tensorflow_BundleHeaderProto.Endianness] = [
    .little,
    .big,
  ]
}
...
extension Tensorflow_BundleHeaderProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_BundleHeaderProto, rhs: Tensorflow_BundleHeaderProto) -> Bool {
...
extension Tensorflow_BundleEntryProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_BundleEntryProto, rhs: Tensorflow_BundleEntryProto) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
