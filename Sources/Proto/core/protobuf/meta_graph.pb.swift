...
public struct Tensorflow_MetaGraphDef {
  ...
  public struct MetaInfoDef {
    ...
    public mutating func clearStrippedOpList() {_uniqueStorage()._strippedOpList = nil}
    ...
    public mutating func clearAnyInfo() {_uniqueStorage()._anyInfo = nil}
    ...
    public var strippedDefaultAttrs: Bool {
      get {return _storage._strippedDefaultAttrs}
      set {_uniqueStorage()._strippedDefaultAttrs = newValue}
    }
...
public struct Tensorflow_AssetFileDef {
  ...
  public mutating func clearTensorInfo() {_uniqueStorage()._tensorInfo = nil}
...
extension Tensorflow_MetaGraphDef.MetaInfoDef: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _strippedDefaultAttrs: Bool = false
    ...
    init(copying source: _StorageClass) {
      ...
      _strippedDefaultAttrs = source._strippedDefaultAttrs
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 7: try decoder.decodeSingularBoolField(value: &_storage._strippedDefaultAttrs)
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if _storage._strippedDefaultAttrs != false {
        try visitor.visitSingularBoolField(value: _storage._strippedDefaultAttrs, fieldNumber: 7)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: Tensorflow_MetaGraphDef.MetaInfoDef, rhs: Tensorflow_MetaGraphDef.MetaInfoDef) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._metaGraphVersion != rhs_storage._metaGraphVersion {return false}
        if _storage._strippedOpList != rhs_storage._strippedOpList {return false}
        if _storage._anyInfo != rhs_storage._anyInfo {return false}
        if _storage._tags != rhs_storage._tags {return false}
        if _storage._tensorflowVersion != rhs_storage._tensorflowVersion {return false}
        if _storage._tensorflowGitVersion != rhs_storage._tensorflowGitVersion {return false}
        if _storage._strippedDefaultAttrs != rhs_storage._strippedDefaultAttrs {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
  ...
  public static func ==(lhs: Tensorflow_AssetFileDef, rhs: Tensorflow_AssetFileDef) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._tensorInfo != rhs_storage._tensorInfo {return false}
