...
public struct Tensorflow_Eager_QueueResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tensorflow_Eager_CreateContextRequest {
  ...
  public mutating func clearVersionDef() {_uniqueStorage()._versionDef = nil}
...
public struct Tensorflow_Eager_EnqueueResponse {
  ...
  public var queueResponse: [Tensorflow_Eager_QueueResponse] = []
...
public struct Tensorflow_Eager_RegisterFunctionRequest {
  ...
  public mutating func clearFunctionDef() {_uniqueStorage()._functionDef = nil}
...
public struct Tensorflow_Eager_SendTensorRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tensorflow_Eager_SendTensorResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Tensorflow_Eager_RemoteTensorHandle: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Eager_RemoteTensorHandle, rhs: Tensorflow_Eager_RemoteTensorHandle) -> Bool {
    if lhs.opID != rhs.opID {return false}
    if lhs.outputNum != rhs.outputNum {return false}
...
extension Tensorflow_Eager_Operation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Eager_Operation, rhs: Tensorflow_Eager_Operation) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.name != rhs.name {return false}
    if lhs.inputs != rhs.inputs {return false}
    if lhs.controlOpIds != rhs.controlOpIds {return false}
...
extension Tensorflow_Eager_QueueItem: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Eager_QueueItem, rhs: Tensorflow_Eager_QueueItem) -> Bool {
...
extension Tensorflow_Eager_QueueResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".QueueResponse"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "shape"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeRepeatedMessageField(value: &self.shape)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.shape.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.shape, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Tensorflow_Eager_QueueResponse, rhs: Tensorflow_Eager_QueueResponse) -> Bool {
...
extension Tensorflow_Eager_CreateContextRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Eager_CreateContextRequest, rhs: Tensorflow_Eager_CreateContextRequest) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        ...
        if _storage._keepAliveSecs != rhs_storage._keepAliveSecs {return false}
        if _storage._versionDef != rhs_storage._versionDef {return false}
        if _storage._rendezvousID != rhs_storage._rendezvousID {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension Tensorflow_Eager_CreateContextResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Eager_CreateContextResponse, rhs: Tensorflow_Eager_CreateContextResponse) -> Bool {
...
extension Tensorflow_Eager_EnqueueRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Eager_EnqueueRequest, rhs: Tensorflow_Eager_EnqueueRequest) -> Bool {
    if lhs.contextID != rhs.contextID {return false}
...
extension Tensorflow_Eager_EnqueueResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "queue_response"),
  ]

  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeRepeatedMessageField(value: &self.queueResponse)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.queueResponse.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.queueResponse, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Tensorflow_Eager_EnqueueResponse, rhs: Tensorflow_Eager_EnqueueResponse) -> Bool {
    if lhs.queueResponse != rhs.queueResponse {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Tensorflow_Eager_WaitQueueDoneRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Eager_WaitQueueDoneRequest, rhs: Tensorflow_Eager_WaitQueueDoneRequest) -> Bool {
    if lhs.contextID != rhs.contextID {return false}
    if lhs.opID != rhs.opID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Tensorflow_Eager_WaitQueueDoneResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Eager_WaitQueueDoneResponse, rhs: Tensorflow_Eager_WaitQueueDoneResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Tensorflow_Eager_KeepAliveRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Eager_KeepAliveRequest, rhs: Tensorflow_Eager_KeepAliveRequest) -> Bool {
    if lhs.contextID != rhs.contextID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Tensorflow_Eager_KeepAliveResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Eager_KeepAliveResponse, rhs: Tensorflow_Eager_KeepAliveResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Tensorflow_Eager_CloseContextRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Eager_CloseContextRequest, rhs: Tensorflow_Eager_CloseContextRequest) -> Bool {
    if lhs.contextID != rhs.contextID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Tensorflow_Eager_CloseContextResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Eager_CloseContextResponse, rhs: Tensorflow_Eager_CloseContextResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Tensorflow_Eager_RegisterFunctionRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Eager_RegisterFunctionRequest, rhs: Tensorflow_Eager_RegisterFunctionRequest) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._contextID != rhs_storage._contextID {return false}
        if _storage._functionDef != rhs_storage._functionDef {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension Tensorflow_Eager_RegisterFunctionResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Eager_RegisterFunctionResponse, rhs: Tensorflow_Eager_RegisterFunctionResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Tensorflow_Eager_SendTensorRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SendTensorRequest"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "context_id"),
    2: .standard(proto: "op_id"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularFixed64Field(value: &self.contextID)
      case 2: try decoder.decodeSingularInt64Field(value: &self.opID)
      case 3: try decoder.decodeRepeatedMessageField(value: &self.tensors)
      case 4: try decoder.decodeSingularStringField(value: &self.deviceName)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.opID != 0 {
      try visitor.visitSingularInt64Field(value: self.opID, fieldNumber: 2)
    }
  ...
  public static func ==(lhs: Tensorflow_Eager_SendTensorRequest, rhs: Tensorflow_Eager_SendTensorRequest) -> Bool {
    if lhs.contextID != rhs.contextID {return false}
    if lhs.opID != rhs.opID {return false}
...
extension Tensorflow_Eager_SendTensorResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SendTensorResponse"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  public static func ==(lhs: Tensorflow_Eager_SendTensorResponse, rhs: Tensorflow_Eager_SendTensorResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
