...
public struct Tensorflow_ServerDef {
  ...
  public mutating func clearDefaultSessionConfig() {_uniqueStorage()._defaultSessionConfig = nil}
...
extension Tensorflow_ServerDef: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_ServerDef, rhs: Tensorflow_ServerDef) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._taskIndex != rhs_storage._taskIndex {return false}
        if _storage._defaultSessionConfig != rhs_storage._defaultSessionConfig {return false}
