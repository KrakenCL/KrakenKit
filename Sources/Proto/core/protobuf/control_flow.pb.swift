...
public struct Tensorflow_CondContextDef {
  ...
  public mutating func clearValuesDef() {_uniqueStorage()._valuesDef = nil}
...
extension Tensorflow_ValuesDef: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_ValuesDef, rhs: Tensorflow_ValuesDef) -> Bool {
    if lhs.values != rhs.values {return false}
    if lhs.externalValues != rhs.externalValues {return false}
...
extension Tensorflow_ControlFlowContextDef: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_ControlFlowContextDef, rhs: Tensorflow_ControlFlowContextDef) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._ctxt != rhs_storage._ctxt {return false}
        return true
      }
...
extension Tensorflow_CondContextDef: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_CondContextDef, rhs: Tensorflow_CondContextDef) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._contextName != rhs_storage._contextName {return false}
        if _storage._predName != rhs_storage._predName {return false}
        if _storage._pivotName != rhs_storage._pivotName {return false}
        if _storage._branch != rhs_storage._branch {return false}
        if _storage._valuesDef != rhs_storage._valuesDef {return false}
        if _storage._nestedContexts != rhs_storage._nestedContexts {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension Tensorflow_WhileContextDef: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_WhileContextDef, rhs: Tensorflow_WhileContextDef) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._contextName != rhs_storage._contextName {return false}
        if _storage._parallelIterations != rhs_storage._parallelIterations {return false}
        if _storage._backProp != rhs_storage._backProp {return false}
        if _storage._swapMemory != rhs_storage._swapMemory {return false}
        if _storage._pivotName != rhs_storage._pivotName {return false}
        if _storage._pivotForPredName != rhs_storage._pivotForPredName {return false}
        if _storage._pivotForBodyName != rhs_storage._pivotForBodyName {return false}
        if _storage._loopExitNames != rhs_storage._loopExitNames {return false}
        if _storage._loopEnterNames != rhs_storage._loopEnterNames {return false}
        if _storage._valuesDef != rhs_storage._valuesDef {return false}
        if _storage._maximumIterationsName != rhs_storage._maximumIterationsName {return false}
        if _storage._nestedContexts != rhs_storage._nestedContexts {return false}
        return true
      }
      if !storagesAreEqual {return false}
