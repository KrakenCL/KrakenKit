...
public struct Tensorflow_BoostedTrees_Node {
  ...
  public var categoricalSplit: Tensorflow_BoostedTrees_CategoricalSplit {
    get {
      if case .categoricalSplit(let v)? = _storage._node {return v}
      return Tensorflow_BoostedTrees_CategoricalSplit()
    }
    set {_uniqueStorage()._node = .categoricalSplit(newValue)}
  }

  public var denseSplit: Tensorflow_BoostedTrees_DenseSplit {
    get {
      if case .denseSplit(let v)? = _storage._node {return v}
      return Tensorflow_BoostedTrees_DenseSplit()
    }
    set {_uniqueStorage()._node = .denseSplit(newValue)}
  }
  ...
  public enum OneOf_Node: Equatable {
    ...
    case categoricalSplit(Tensorflow_BoostedTrees_CategoricalSplit)
    case denseSplit(Tensorflow_BoostedTrees_DenseSplit)
    ...
    public static func ==(lhs: Tensorflow_BoostedTrees_Node.OneOf_Node, rhs: Tensorflow_BoostedTrees_Node.OneOf_Node) -> Bool {
      ...
      case (.categoricalSplit(let l), .categoricalSplit(let r)): return l == r
      case (.denseSplit(let l), .denseSplit(let r)): return l == r
...
public struct Tensorflow_BoostedTrees_CategoricalSplit {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tensorflow_BoostedTrees_DenseSplit {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tensorflow_BoostedTrees_DebugOutput {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// id.
  public var featureIds: [Int32] = []

  public var logitsPath: [Float] = []
...
extension Tensorflow_BoostedTrees_Node: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    3: .standard(proto: "categorical_split"),
    4: .standard(proto: "dense_split"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 3:
          var v: Tensorflow_BoostedTrees_CategoricalSplit?
          if let current = _storage._node {
            try decoder.handleConflictingOneOf()
            if case .categoricalSplit(let m) = current {v = m}
          }
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {_storage._node = .categoricalSplit(v)}
        case 4:
          var v: Tensorflow_BoostedTrees_DenseSplit?
          if let current = _storage._node {
            try decoder.handleConflictingOneOf()
            if case .denseSplit(let m) = current {v = m}
          }
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {_storage._node = .denseSplit(v)}
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      case .categoricalSplit(let v)?:
        try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
      case .denseSplit(let v)?:
  ...
  public static func ==(lhs: Tensorflow_BoostedTrees_Node, rhs: Tensorflow_BoostedTrees_Node) -> Bool {
...
extension Tensorflow_BoostedTrees_NodeMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_BoostedTrees_NodeMetadata, rhs: Tensorflow_BoostedTrees_NodeMetadata) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Tensorflow_BoostedTrees_Leaf: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_BoostedTrees_Leaf, rhs: Tensorflow_BoostedTrees_Leaf) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Tensorflow_BoostedTrees_Vector: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_BoostedTrees_Vector, rhs: Tensorflow_BoostedTrees_Vector) -> Bool {
...
extension Tensorflow_BoostedTrees_SparseVector: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_BoostedTrees_SparseVector, rhs: Tensorflow_BoostedTrees_SparseVector) -> Bool {
...
extension Tensorflow_BoostedTrees_BucketizedSplit: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_BoostedTrees_BucketizedSplit, rhs: Tensorflow_BoostedTrees_BucketizedSplit) -> Bool {
...
extension Tensorflow_BoostedTrees_CategoricalSplit: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".CategoricalSplit"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "feature_id"),
    2: .same(proto: "value"),
    3: .standard(proto: "left_id"),
  ...
  public static func ==(lhs: Tensorflow_BoostedTrees_CategoricalSplit, rhs: Tensorflow_BoostedTrees_CategoricalSplit) -> Bool {
    if lhs.featureID != rhs.featureID {return false}
    if lhs.value != rhs.value {return false}
    if lhs.leftID != rhs.leftID {return false}
    if lhs.rightID != rhs.rightID {return false}
...
extension Tensorflow_BoostedTrees_DenseSplit: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".DenseSplit"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "feature_id"),
    2: .same(proto: "threshold"),
    3: .standard(proto: "left_id"),
  ...
  public static func ==(lhs: Tensorflow_BoostedTrees_DenseSplit, rhs: Tensorflow_BoostedTrees_DenseSplit) -> Bool {
    if lhs.featureID != rhs.featureID {return false}
    if lhs.threshold != rhs.threshold {return false}
    if lhs.leftID != rhs.leftID {return false}
    if lhs.rightID != rhs.rightID {return false}
...
extension Tensorflow_BoostedTrees_Tree: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_BoostedTrees_Tree, rhs: Tensorflow_BoostedTrees_Tree) -> Bool {
...
extension Tensorflow_BoostedTrees_TreeMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_BoostedTrees_TreeMetadata, rhs: Tensorflow_BoostedTrees_TreeMetadata) -> Bool {
    if lhs.numLayersGrown != rhs.numLayersGrown {return false}
    if lhs.isFinalized != rhs.isFinalized {return false}
    if lhs.postPrunedNodesMeta != rhs.postPrunedNodesMeta {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Tensorflow_BoostedTrees_TreeMetadata.PostPruneNodeUpdate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_BoostedTrees_TreeMetadata.PostPruneNodeUpdate, rhs: Tensorflow_BoostedTrees_TreeMetadata.PostPruneNodeUpdate) -> Bool {
    if lhs.newNodeID != rhs.newNodeID {return false}
    if lhs.logitChange != rhs.logitChange {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Tensorflow_BoostedTrees_GrowingMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_BoostedTrees_GrowingMetadata, rhs: Tensorflow_BoostedTrees_GrowingMetadata) -> Bool {
    if lhs.numTreesAttempted != rhs.numTreesAttempted {return false}
    if lhs.numLayersAttempted != rhs.numLayersAttempted {return false}
    if lhs.lastLayerNodeStart != rhs.lastLayerNodeStart {return false}
    if lhs.lastLayerNodeEnd != rhs.lastLayerNodeEnd {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Tensorflow_BoostedTrees_TreeEnsemble: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_BoostedTrees_TreeEnsemble, rhs: Tensorflow_BoostedTrees_TreeEnsemble) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Tensorflow_BoostedTrees_DebugOutput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".DebugOutput"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "feature_ids"),
    2: .standard(proto: "logits_path"),
  ]

  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeRepeatedInt32Field(value: &self.featureIds)
      case 2: try decoder.decodeRepeatedFloatField(value: &self.logitsPath)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.featureIds.isEmpty {
      try visitor.visitPackedInt32Field(value: self.featureIds, fieldNumber: 1)
    }
    if !self.logitsPath.isEmpty {
      try visitor.visitPackedFloatField(value: self.logitsPath, fieldNumber: 2)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Tensorflow_BoostedTrees_DebugOutput, rhs: Tensorflow_BoostedTrees_DebugOutput) -> Bool {
    if lhs.featureIds != rhs.featureIds {return false}
    if lhs.logitsPath != rhs.logitsPath {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
