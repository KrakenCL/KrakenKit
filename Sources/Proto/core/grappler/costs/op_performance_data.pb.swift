...
public struct Tensorflow_SessionInfo {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var intraOpParallelism: Int64 = 0
...
/// performance.
public struct Tensorflow_OpInfo {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var sessionInfo: Tensorflow_SessionInfo {
    get {return _storage._sessionInfo ?? Tensorflow_SessionInfo()}
  ...
  public struct TensorProperties {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
public struct Tensorflow_NormalDistribution {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tensorflow_LogNormalDistribution {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tensorflow_OpPerformance {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public mutating func clearOpMemory() {_uniqueStorage()._opMemory = nil}
  ...
  public struct OpMemory {
    ...
    public var tempMemory: Int64 = 0

    public var persistentMemory: Int64 = 0
...
public struct Tensorflow_OpPerformanceList {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Tensorflow_SessionInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SessionInfo"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "intra_op_parallelism"),
  ]

  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularInt64Field(value: &self.intraOpParallelism)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if self.intraOpParallelism != 0 {
      try visitor.visitSingularInt64Field(value: self.intraOpParallelism, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Tensorflow_SessionInfo, rhs: Tensorflow_SessionInfo) -> Bool {
    if lhs.intraOpParallelism != rhs.intraOpParallelism {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Tensorflow_OpInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _sessionInfo: Tensorflow_SessionInfo? = nil
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 6: try decoder.decodeSingularMessageField(value: &_storage._sessionInfo)
        default: break
        }
      }
    }
  ...
  public static func ==(lhs: Tensorflow_OpInfo, rhs: Tensorflow_OpInfo) -> Bool {
...
extension Tensorflow_OpInfo.TensorProperties: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_OpInfo.TensorProperties, rhs: Tensorflow_OpInfo.TensorProperties) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Tensorflow_NormalDistribution: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_NormalDistribution, rhs: Tensorflow_NormalDistribution) -> Bool {
...
extension Tensorflow_LogNormalDistribution: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_LogNormalDistribution, rhs: Tensorflow_LogNormalDistribution) -> Bool {
    if lhs.mu != rhs.mu {return false}
    if lhs.sigma != rhs.sigma {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Tensorflow_OpPerformance: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 12: try decoder.decodeSingularMessageField(value: &_storage._sessionInfo)
        default: break
        }
      }
    }
  ...
  public static func ==(lhs: Tensorflow_OpPerformance, rhs: Tensorflow_OpPerformance) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        ...
        if _storage._temporaryMemorySize != rhs_storage._temporaryMemorySize {return false}
        if _storage._computeCost != rhs_storage._computeCost {return false}
        if _storage._computeTime != rhs_storage._computeTime {return false}
        if _storage._memoryTime != rhs_storage._memoryTime {return false}
        if _storage._computeEfficiency != rhs_storage._computeEfficiency {return false}
        if _storage._memoryEfficiency != rhs_storage._memoryEfficiency {return false}
        if _storage._executionTime != rhs_storage._executionTime {return false}
        if _storage._opMemory != rhs_storage._opMemory {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension Tensorflow_OpPerformance.OpMemory: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    2: .standard(proto: "temp_memory"),
    4: .standard(proto: "persistent_memory"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularInt64Field(value: &self.tempMemory)
      case 3: try decoder.decodeSingularInt64Field(value: &self.deviceTempMemory)
      case 4: try decoder.decodeSingularInt64Field(value: &self.persistentMemory)
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.tempMemory != 0 {
      try visitor.visitSingularInt64Field(value: self.tempMemory, fieldNumber: 2)
    }
    if self.deviceTempMemory != 0 {
      try visitor.visitSingularInt64Field(value: self.deviceTempMemory, fieldNumber: 3)
    }
    if self.persistentMemory != 0 {
      try visitor.visitSingularInt64Field(value: self.persistentMemory, fieldNumber: 4)
    }
  ...
  public static func ==(lhs: Tensorflow_OpPerformance.OpMemory, rhs: Tensorflow_OpPerformance.OpMemory) -> Bool {
    if lhs.outputMemory != rhs.outputMemory {return false}
    if lhs.tempMemory != rhs.tempMemory {return false}
    if lhs.persistentMemory != rhs.persistentMemory {return false}
    if lhs.deviceTempMemory != rhs.deviceTempMemory {return false}
    if lhs.devicePersistentMemory != rhs.devicePersistentMemory {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Tensorflow_OpPerformanceList: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_OpPerformanceList, rhs: Tensorflow_OpPerformanceList) -> Bool {
    if lhs.opPerformance != rhs.opPerformance {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
