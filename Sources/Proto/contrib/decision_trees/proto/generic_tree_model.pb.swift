...
public struct Tensorflow_DecisionTrees_Ensemble {
  ...
  public struct Member {
    ...
    public mutating func clearSubmodel() {_uniqueStorage()._submodel = nil}
    ...
    public mutating func clearSubmodelID() {_uniqueStorage()._submodelID = nil}
...
public struct Tensorflow_DecisionTrees_TreeNode {
  ...
  public mutating func clearNodeID() {_uniqueStorage()._nodeID = nil}
  ...
  public mutating func clearSubtreeSize() {_uniqueStorage()._subtreeSize = nil}
...
public struct Tensorflow_DecisionTrees_BinaryNode {
  ...
  public mutating func clearLeftChildID() {_uniqueStorage()._leftChildID = nil}
  ...
  public mutating func clearRightChildID() {_uniqueStorage()._rightChildID = nil}
...
extension Tensorflow_DecisionTrees_BinaryNode.Direction: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Tensorflow_DecisionTrees_BinaryNode.Direction] = [
    .left,
    .right,
  ]
}
...
extension Tensorflow_DecisionTrees_InequalityTest.TypeEnum: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Tensorflow_DecisionTrees_InequalityTest.TypeEnum] = [
    .lessOrEqual,
    .lessThan,
    .greaterOrEqual,
    .greaterThan,
...
extension Tensorflow_DecisionTrees_Model: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_DecisionTrees_Model, rhs: Tensorflow_DecisionTrees_Model) -> Bool {
...
extension Tensorflow_DecisionTrees_ModelAndFeatures: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_DecisionTrees_ModelAndFeatures, rhs: Tensorflow_DecisionTrees_ModelAndFeatures) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Tensorflow_DecisionTrees_ModelAndFeatures.Feature: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_DecisionTrees_ModelAndFeatures.Feature, rhs: Tensorflow_DecisionTrees_ModelAndFeatures.Feature) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Tensorflow_DecisionTrees_Ensemble: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_DecisionTrees_Ensemble, rhs: Tensorflow_DecisionTrees_Ensemble) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._members != rhs_storage._members {return false}
        if _storage._combinationTechnique != rhs_storage._combinationTechnique {return false}
        if _storage._additionalData != rhs_storage._additionalData {return false}
        return true
      }
      if !storagesAreEqual {return false}
...
extension Tensorflow_DecisionTrees_Ensemble.Member: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_DecisionTrees_Ensemble.Member, rhs: Tensorflow_DecisionTrees_Ensemble.Member) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._submodel != rhs_storage._submodel {return false}
        if _storage._submodelID != rhs_storage._submodelID {return false}
        if _storage._additionalData != rhs_storage._additionalData {return false}
        return true
      }
      if !storagesAreEqual {return false}
...
extension Tensorflow_DecisionTrees_Summation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_DecisionTrees_Summation, rhs: Tensorflow_DecisionTrees_Summation) -> Bool {
...
extension Tensorflow_DecisionTrees_Averaging: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_DecisionTrees_Averaging, rhs: Tensorflow_DecisionTrees_Averaging) -> Bool {
    if lhs.additionalData != rhs.additionalData {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Tensorflow_DecisionTrees_DecisionTree: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_DecisionTrees_DecisionTree, rhs: Tensorflow_DecisionTrees_DecisionTree) -> Bool {
...
extension Tensorflow_DecisionTrees_TreeNode: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_DecisionTrees_TreeNode, rhs: Tensorflow_DecisionTrees_TreeNode) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        ...
        if _storage._subtreeSize != rhs_storage._subtreeSize {return false}
...
extension Tensorflow_DecisionTrees_BinaryNode: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_DecisionTrees_BinaryNode, rhs: Tensorflow_DecisionTrees_BinaryNode) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._leftChildID != rhs_storage._leftChildID {return false}
        if _storage._rightChildID != rhs_storage._rightChildID {return false}
        if _storage._defaultDirection != rhs_storage._defaultDirection {return false}
        if _storage._leftChildTest != rhs_storage._leftChildTest {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension Tensorflow_DecisionTrees_SparseVector: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_DecisionTrees_SparseVector, rhs: Tensorflow_DecisionTrees_SparseVector) -> Bool {
    if lhs.sparseValue != rhs.sparseValue {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Tensorflow_DecisionTrees_Vector: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_DecisionTrees_Vector, rhs: Tensorflow_DecisionTrees_Vector) -> Bool {
...
extension Tensorflow_DecisionTrees_Leaf: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_DecisionTrees_Leaf, rhs: Tensorflow_DecisionTrees_Leaf) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Tensorflow_DecisionTrees_FeatureId: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_DecisionTrees_FeatureId, rhs: Tensorflow_DecisionTrees_FeatureId) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Tensorflow_DecisionTrees_ObliqueFeatures: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_DecisionTrees_ObliqueFeatures, rhs: Tensorflow_DecisionTrees_ObliqueFeatures) -> Bool {
...
extension Tensorflow_DecisionTrees_InequalityTest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_DecisionTrees_InequalityTest, rhs: Tensorflow_DecisionTrees_InequalityTest) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._featureSum != rhs_storage._featureSum {return false}
...
extension Tensorflow_DecisionTrees_Value: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_DecisionTrees_Value, rhs: Tensorflow_DecisionTrees_Value) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
