...
extension Tensorflow_Tpu_TopologyProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Tpu_TopologyProto, rhs: Tensorflow_Tpu_TopologyProto) -> Bool {
    if lhs.meshShape != rhs.meshShape {return false}
    if lhs.numTasks != rhs.numTasks {return false}
    if lhs.numTpuDevicesPerTask != rhs.numTpuDevicesPerTask {return false}
    if lhs.deviceCoordinates != rhs.deviceCoordinates {return false}
