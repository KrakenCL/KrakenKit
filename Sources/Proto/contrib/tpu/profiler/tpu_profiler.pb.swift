...
public struct Tensorflow_ProfileRequest {
  ...
  public mutating func clearOpts() {_uniqueStorage()._opts = nil}
...
public struct Tensorflow_ProfileResponse {
  ...
  public mutating func clearHloMetadata() {_uniqueStorage()._hloMetadata = nil}
  ...
  public mutating func clearOpProfile() {_uniqueStorage()._opProfile = nil}
...
public struct Tensorflow_MonitorRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var monitoringLevel: Int32 = 0
...
public struct Tensorflow_MonitorResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Tensorflow_ProfileOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_ProfileOptions, rhs: Tensorflow_ProfileOptions) -> Bool {
    if lhs.includeDatasetOps != rhs.includeDatasetOps {return false}
...
extension Tensorflow_ToolRequestOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_ToolRequestOptions, rhs: Tensorflow_ToolRequestOptions) -> Bool {
    if lhs.outputFormats != rhs.outputFormats {return false}
    if lhs.saveToRepo != rhs.saveToRepo {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Tensorflow_ProfileRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_ProfileRequest, rhs: Tensorflow_ProfileRequest) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._toolOptions != rhs_storage._toolOptions {return false}
        if _storage._opts != rhs_storage._opts {return false}
...
extension Tensorflow_ProfileToolData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_ProfileToolData, rhs: Tensorflow_ProfileToolData) -> Bool {
...
extension Tensorflow_ProfileResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_ProfileResponse, rhs: Tensorflow_ProfileResponse) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._computationGraph != rhs_storage._computationGraph {return false}
        if _storage._hloMetadata != rhs_storage._hloMetadata {return false}
        if _storage._encodedTrace != rhs_storage._encodedTrace {return false}
        if _storage._opProfile != rhs_storage._opProfile {return false}
        if _storage._toolData != rhs_storage._toolData {return false}
        if _storage._emptyTrace != rhs_storage._emptyTrace {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension Tensorflow_MonitorRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".MonitorRequest"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "duration_ms"),
    2: .standard(proto: "monitoring_level"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularInt32Field(value: &self.monitoringLevel)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.monitoringLevel != 0 {
      try visitor.visitSingularInt32Field(value: self.monitoringLevel, fieldNumber: 2)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Tensorflow_MonitorRequest, rhs: Tensorflow_MonitorRequest) -> Bool {
    if lhs.durationMs != rhs.durationMs {return false}
    if lhs.monitoringLevel != rhs.monitoringLevel {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Tensorflow_MonitorResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_MonitorResponse, rhs: Tensorflow_MonitorResponse) -> Bool {
    if lhs.data != rhs.data {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
