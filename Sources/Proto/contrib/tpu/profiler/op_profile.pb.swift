...
public struct Tensorflow_Tpu_OpProfile_Profile {
  ...
  public mutating func clearByCategory() {_uniqueStorage()._byCategory = nil}

  /// Root of a profile broken down by program.
  public var byProgram: Tensorflow_Tpu_OpProfile_Node {
    get {return _storage._byProgram ?? Tensorflow_Tpu_OpProfile_Node()}
    set {_uniqueStorage()._byProgram = newValue}
  }
  /// Returns true if `byProgram` has been explicitly set.
  public var hasByProgram: Bool {return _storage._byProgram != nil}
  /// Clears the value of `byProgram`. Subsequent reads from it will return its default value.
  public mutating func clearByProgram() {_uniqueStorage()._byProgram = nil}
...
public struct Tensorflow_Tpu_OpProfile_Node {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var numChildren: Int32 {
    get {return _storage._numChildren}
    set {_uniqueStorage()._numChildren = newValue}
  }
  ...
  public struct InstructionCategory {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
public struct Tensorflow_Tpu_OpProfile_Metrics {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var memoryBandwidth: Double = 0
  ...
  public var rawBytesAccessed: Double = 0
...
extension Tensorflow_Tpu_OpProfile_Profile: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Profile"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "by_category"),
    4: .standard(proto: "by_program"),
  ]

  fileprivate class _StorageClass {
    var _byCategory: Tensorflow_Tpu_OpProfile_Node? = nil
    var _byProgram: Tensorflow_Tpu_OpProfile_Node? = nil
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 4: try decoder.decodeSingularMessageField(value: &_storage._byProgram)
        default: break
        }
      }
    }
  ...
  public static func ==(lhs: Tensorflow_Tpu_OpProfile_Profile, rhs: Tensorflow_Tpu_OpProfile_Profile) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._byCategory != rhs_storage._byCategory {return false}
        if _storage._byProgram != rhs_storage._byProgram {return false}
        return true
      }
...
extension Tensorflow_Tpu_OpProfile_Node: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    init(copying source: _StorageClass) {
      ...
      _numChildren = source._numChildren
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 6: try decoder.decodeSingularInt32Field(value: &_storage._numChildren)
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if _storage._numChildren != 0 {
        try visitor.visitSingularInt32Field(value: _storage._numChildren, fieldNumber: 6)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Tensorflow_Tpu_OpProfile_Node, rhs: Tensorflow_Tpu_OpProfile_Node) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        ...
        if _storage._numChildren != rhs_storage._numChildren {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension Tensorflow_Tpu_OpProfile_Node.InstructionCategory: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Tpu_OpProfile_Node.InstructionCategory, rhs: Tensorflow_Tpu_OpProfile_Node.InstructionCategory) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Tensorflow_Tpu_OpProfile_Node.XLAInstruction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Tpu_OpProfile_Node.XLAInstruction, rhs: Tensorflow_Tpu_OpProfile_Node.XLAInstruction) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Tensorflow_Tpu_OpProfile_Node.XLAInstruction.LayoutAnalysis: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Tpu_OpProfile_Node.XLAInstruction.LayoutAnalysis, rhs: Tensorflow_Tpu_OpProfile_Node.XLAInstruction.LayoutAnalysis) -> Bool {
...
extension Tensorflow_Tpu_OpProfile_Node.XLAInstruction.LayoutAnalysis.Dimension: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Tpu_OpProfile_Node.XLAInstruction.LayoutAnalysis.Dimension, rhs: Tensorflow_Tpu_OpProfile_Node.XLAInstruction.LayoutAnalysis.Dimension) -> Bool {
    if lhs.size != rhs.size {return false}
    if lhs.alignment != rhs.alignment {return false}
    if lhs.semantics != rhs.semantics {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Tensorflow_Tpu_OpProfile_Metrics: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Metrics"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "time"),
    2: .same(proto: "flops"),
    3: .standard(proto: "memory_bandwidth"),
    11: .standard(proto: "raw_time"),
    12: .standard(proto: "raw_flops"),
    13: .standard(proto: "raw_bytes_accessed"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try decoder.decodeSingularDoubleField(value: &self.memoryBandwidth)
      ...
      case 13: try decoder.decodeSingularDoubleField(value: &self.rawBytesAccessed)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.memoryBandwidth != 0 {
      try visitor.visitSingularDoubleField(value: self.memoryBandwidth, fieldNumber: 3)
    }
    if self.rawTime != 0 {
    ...
    if self.rawBytesAccessed != 0 {
      try visitor.visitSingularDoubleField(value: self.rawBytesAccessed, fieldNumber: 13)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Tensorflow_Tpu_OpProfile_Metrics, rhs: Tensorflow_Tpu_OpProfile_Metrics) -> Bool {
    if lhs.time != rhs.time {return false}
    if lhs.flops != rhs.flops {return false}
    if lhs.memoryBandwidth != rhs.memoryBandwidth {return false}
    if lhs.rawTime != rhs.rawTime {return false}
    if lhs.rawFlops != rhs.rawFlops {return false}
    if lhs.rawBytesAccessed != rhs.rawBytesAccessed {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
