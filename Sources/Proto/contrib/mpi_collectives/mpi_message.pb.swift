...
extension Tensorflow_Contrib_MpiCollectives_MPIRequest.RequestType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Tensorflow_Contrib_MpiCollectives_MPIRequest.RequestType] = [
    .allreduce,
    .allgather,
  ]
}
...
extension Tensorflow_Contrib_MpiCollectives_MPIResponse.ResponseType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Tensorflow_Contrib_MpiCollectives_MPIResponse.ResponseType] = [
    .allreduce,
    .allgather,
    .error,
    .done,
...
extension Tensorflow_Contrib_MpiCollectives_MPIRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Contrib_MpiCollectives_MPIRequest, rhs: Tensorflow_Contrib_MpiCollectives_MPIRequest) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._requestRank != rhs_storage._requestRank {return false}
        if _storage._requestType != rhs_storage._requestType {return false}
        if _storage._tensorType != rhs_storage._tensorType {return false}
...
extension Tensorflow_Contrib_MpiCollectives_MPIResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Contrib_MpiCollectives_MPIResponse, rhs: Tensorflow_Contrib_MpiCollectives_MPIResponse) -> Bool {
