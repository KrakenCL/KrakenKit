...
public struct Tensorflow_BoostedTrees_Learner_SplitInfo {
  ...
  public mutating func clearSplitNode() {_uniqueStorage()._splitNode = nil}
  ...
  public mutating func clearLeftChild() {_uniqueStorage()._leftChild = nil}
  ...
  public mutating func clearRightChild() {_uniqueStorage()._rightChild = nil}
...
public struct Tensorflow_BoostedTrees_Learner_ObliviousSplitInfo {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var children: [Tensorflow_BoostedTrees_Trees_Leaf] {
  ...
  /// children_parent_id.
  public var childrenParentID: [Int32] {
    get {return _storage._childrenParentID}
    set {_uniqueStorage()._childrenParentID = newValue}
  }
...
extension Tensorflow_BoostedTrees_Learner_SplitInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_BoostedTrees_Learner_SplitInfo, rhs: Tensorflow_BoostedTrees_Learner_SplitInfo) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._splitNode != rhs_storage._splitNode {return false}
        if _storage._leftChild != rhs_storage._leftChild {return false}
        if _storage._rightChild != rhs_storage._rightChild {return false}
        return true
      }
...
extension Tensorflow_BoostedTrees_Learner_ObliviousSplitInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ObliviousSplitInfo"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "split_node"),
    2: .same(proto: "children"),
    3: .standard(proto: "children_parent_id"),
  ]

  fileprivate class _StorageClass {
    var _splitNode: Tensorflow_BoostedTrees_Trees_TreeNode? = nil
    var _children: [Tensorflow_BoostedTrees_Trees_Leaf] = []
    var _childrenParentID: [Int32] = []
    ...
    init(copying source: _StorageClass) {
      ...
      _childrenParentID = source._childrenParentID
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 3: try decoder.decodeRepeatedInt32Field(value: &_storage._childrenParentID)
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._childrenParentID.isEmpty {
        try visitor.visitPackedInt32Field(value: _storage._childrenParentID, fieldNumber: 3)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Tensorflow_BoostedTrees_Learner_ObliviousSplitInfo, rhs: Tensorflow_BoostedTrees_Learner_ObliviousSplitInfo) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        ...
        if _storage._childrenParentID != rhs_storage._childrenParentID {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
