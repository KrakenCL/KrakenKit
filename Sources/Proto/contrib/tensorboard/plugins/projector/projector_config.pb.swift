...
public struct Tensorflow_SpriteMetadata {
...
public struct Tensorflow_EmbeddingInfo {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public mutating func clearSprite() {_uniqueStorage()._sprite = nil}
...
public struct Tensorflow_ProjectorConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Tensorflow_SpriteMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_SpriteMetadata, rhs: Tensorflow_SpriteMetadata) -> Bool {
    if lhs.imagePath != rhs.imagePath {return false}
    if lhs.singleImageDim != rhs.singleImageDim {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Tensorflow_EmbeddingInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_EmbeddingInfo, rhs: Tensorflow_EmbeddingInfo) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._tensorName != rhs_storage._tensorName {return false}
        if _storage._metadataPath != rhs_storage._metadataPath {return false}
        if _storage._bookmarksPath != rhs_storage._bookmarksPath {return false}
        if _storage._tensorShape != rhs_storage._tensorShape {return false}
        if _storage._sprite != rhs_storage._sprite {return false}
        if _storage._tensorPath != rhs_storage._tensorPath {return false}
        return true
      }
...
extension Tensorflow_ProjectorConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_ProjectorConfig, rhs: Tensorflow_ProjectorConfig) -> Bool {
    if lhs.modelCheckpointPath != rhs.modelCheckpointPath {return false}
    if lhs.embeddings != rhs.embeddings {return false}
    if lhs.modelCheckpointDir != rhs.modelCheckpointDir {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
