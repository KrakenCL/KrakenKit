...
public struct Tensorflow_Tensorforest_LeafStat {
  ...
  public struct GiniImpurityClassificationStats {
    ...
    public mutating func clearGini() {_uniqueStorage()._gini = nil}
  ...
  public struct LeastSquaresRegressionStats {
    ...
    public mutating func clearMeanOutput() {_uniqueStorage()._meanOutput = nil}
    ...
    public mutating func clearMeanOutputSquares() {_uniqueStorage()._meanOutputSquares = nil}
...
public struct Tensorflow_Tensorforest_FertileSlot {
  ...
  public mutating func clearLeafStats() {_uniqueStorage()._leafStats = nil}
  ...
  public mutating func clearPostInitLeafStats() {_uniqueStorage()._postInitLeafStats = nil}
...
public struct Tensorflow_Tensorforest_SplitCandidate {
  ...
  public mutating func clearLeftStats() {_uniqueStorage()._leftStats = nil}
  ...
  public mutating func clearRightStats() {_uniqueStorage()._rightStats = nil}
...
extension Tensorflow_Tensorforest_FertileStats: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Tensorforest_FertileStats, rhs: Tensorflow_Tensorforest_FertileStats) -> Bool {
    if lhs.nodeToSlot != rhs.nodeToSlot {return false}
...
extension Tensorflow_Tensorforest_GiniStats: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Tensorforest_GiniStats, rhs: Tensorflow_Tensorforest_GiniStats) -> Bool {
    if lhs.square != rhs.square {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Tensorflow_Tensorforest_LeafStat: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Tensorforest_LeafStat, rhs: Tensorflow_Tensorforest_LeafStat) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._weightSum != rhs_storage._weightSum {return false}
        if _storage._leafStat != rhs_storage._leafStat {return false}
        return true
      }
...
extension Tensorflow_Tensorforest_LeafStat.GiniImpurityClassificationStats: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Tensorforest_LeafStat.GiniImpurityClassificationStats, rhs: Tensorflow_Tensorforest_LeafStat.GiniImpurityClassificationStats) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._counts != rhs_storage._counts {return false}
        if _storage._gini != rhs_storage._gini {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension Tensorflow_Tensorforest_LeafStat.LeastSquaresRegressionStats: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Tensorforest_LeafStat.LeastSquaresRegressionStats, rhs: Tensorflow_Tensorforest_LeafStat.LeastSquaresRegressionStats) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._meanOutput != rhs_storage._meanOutput {return false}
        if _storage._meanOutputSquares != rhs_storage._meanOutputSquares {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension Tensorflow_Tensorforest_FertileSlot: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Tensorforest_FertileSlot, rhs: Tensorflow_Tensorforest_FertileSlot) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._leafStats != rhs_storage._leafStats {return false}
        if _storage._candidates != rhs_storage._candidates {return false}
        if _storage._postInitLeafStats != rhs_storage._postInitLeafStats {return false}
...
extension Tensorflow_Tensorforest_SplitCandidate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Tensorforest_SplitCandidate, rhs: Tensorflow_Tensorforest_SplitCandidate) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._split != rhs_storage._split {return false}
        if _storage._leftStats != rhs_storage._leftStats {return false}
        if _storage._rightStats != rhs_storage._rightStats {return false}
...
extension Tensorflow_Tensorforest_TreePath: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Tensorforest_TreePath, rhs: Tensorflow_Tensorforest_TreePath) -> Bool {
    if lhs.nodesVisited != rhs.nodesVisited {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
