...
extension Tensorflow_Tensorforest_LeafModelType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Tensorflow_Tensorforest_LeafModelType] = [
    .modelDenseClassification,
    .modelSparseClassification,
    .modelRegression,
    .modelSparseOrDenseClassification,
  ]
}
...
extension Tensorflow_Tensorforest_StatsModelType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Tensorflow_Tensorforest_StatsModelType] = [
    .statsDenseGini,
    .statsSparseGini,
...
extension Tensorflow_Tensorforest_SplitCollectionType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Tensorflow_Tensorforest_SplitCollectionType] = [
    .collectionBasic,
    .graphRunnerCollection,
  ]
}
...
extension Tensorflow_Tensorforest_SplitPruningStrategyType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Tensorflow_Tensorforest_SplitPruningStrategyType] = [
    .splitPruneNone,
    .splitPruneHalf,
    .splitPruneQuarter,
    .splitPrune10Percent,
...
extension Tensorflow_Tensorforest_SplitFinishStrategyType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Tensorflow_Tensorforest_SplitFinishStrategyType] = [
    .splitFinishBasic,
    .splitFinishDominateHoeffding,
    .splitFinishDominateBootstrap,
  ]
}

#endif  // swift(>=4.2)

public struct Tensorflow_Tensorforest_SplitPruningConfig {
  ...
  public mutating func clearPruneEverySamples() {_uniqueStorage()._pruneEverySamples = nil}
...
public struct Tensorflow_Tensorforest_SplitFinishConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public mutating func clearCheckEverySteps() {_uniqueStorage()._checkEverySteps = nil}
...
public struct Tensorflow_Tensorforest_LinearParam {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///  k: depth multiplier
///  d: depth
public struct Tensorflow_Tensorforest_ExponentialParam {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tensorflow_Tensorforest_ThresholdParam {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tensorflow_Tensorforest_DepthDependentParam {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tensorflow_Tensorforest_TensorForestParams {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public mutating func clearPruningType() {_uniqueStorage()._pruningType = nil}
  ...
  public mutating func clearFinishType() {_uniqueStorage()._finishType = nil}
  ...
  public mutating func clearNumSplitsToConsider() {_uniqueStorage()._numSplitsToConsider = nil}
  ...
  public mutating func clearSplitAfterSamples() {_uniqueStorage()._splitAfterSamples = nil}
  ...
  public mutating func clearDominateFraction() {_uniqueStorage()._dominateFraction = nil}
  ...
  public mutating func clearMinSplitSamples() {_uniqueStorage()._minSplitSamples = nil}
...
extension Tensorflow_Tensorforest_SplitPruningConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Tensorforest_SplitPruningConfig, rhs: Tensorflow_Tensorforest_SplitPruningConfig) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._pruneEverySamples != rhs_storage._pruneEverySamples {return false}
...
extension Tensorflow_Tensorforest_SplitFinishConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Tensorforest_SplitFinishConfig, rhs: Tensorflow_Tensorforest_SplitFinishConfig) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._checkEverySteps != rhs_storage._checkEverySteps {return false}
        if _storage._type != rhs_storage._type {return false}
        return true
      }
      if !storagesAreEqual {return false}
...
extension Tensorflow_Tensorforest_LinearParam: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Tensorforest_LinearParam, rhs: Tensorflow_Tensorforest_LinearParam) -> Bool {
    if lhs.slope != rhs.slope {return false}
    if lhs.yIntercept != rhs.yIntercept {return false}
...
extension Tensorflow_Tensorforest_ExponentialParam: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Tensorforest_ExponentialParam, rhs: Tensorflow_Tensorforest_ExponentialParam) -> Bool {
    if lhs.bias != rhs.bias {return false}
    if lhs.base != rhs.base {return false}
    if lhs.multiplier != rhs.multiplier {return false}
    if lhs.depthMultiplier != rhs.depthMultiplier {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Tensorflow_Tensorforest_ThresholdParam: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Tensorforest_ThresholdParam, rhs: Tensorflow_Tensorforest_ThresholdParam) -> Bool {
...
extension Tensorflow_Tensorforest_DepthDependentParam: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Tensorforest_DepthDependentParam, rhs: Tensorflow_Tensorforest_DepthDependentParam) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._paramType != rhs_storage._paramType {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension Tensorflow_Tensorforest_TensorForestParams: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tensorflow_Tensorforest_TensorForestParams, rhs: Tensorflow_Tensorforest_TensorForestParams) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._leafType != rhs_storage._leafType {return false}
        if _storage._statsType != rhs_storage._statsType {return false}
        if _storage._collectionType != rhs_storage._collectionType {return false}
        if _storage._pruningType != rhs_storage._pruningType {return false}
        if _storage._finishType != rhs_storage._finishType {return false}
        if _storage._numTrees != rhs_storage._numTrees {return false}
        if _storage._maxNodes != rhs_storage._maxNodes {return false}
        if _storage._numFeatures != rhs_storage._numFeatures {return false}
        if _storage._inequalityTestType != rhs_storage._inequalityTestType {return false}
        if _storage._isRegression != rhs_storage._isRegression {return false}
        if _storage._dropFinalClass != rhs_storage._dropFinalClass {return false}
        if _storage._collateExamples != rhs_storage._collateExamples {return false}
        if _storage._checkpointStats != rhs_storage._checkpointStats {return false}
        if _storage._useRunningStatsMethod != rhs_storage._useRunningStatsMethod {return false}
        if _storage._initializeAverageSplits != rhs_storage._initializeAverageSplits {return false}
        if _storage._inferenceTreePaths != rhs_storage._inferenceTreePaths {return false}
        if _storage._numOutputs != rhs_storage._numOutputs {return false}
        if _storage._numSplitsToConsider != rhs_storage._numSplitsToConsider {return false}
        if _storage._splitAfterSamples != rhs_storage._splitAfterSamples {return false}
        if _storage._dominateFraction != rhs_storage._dominateFraction {return false}
        if _storage._minSplitSamples != rhs_storage._minSplitSamples {return false}
        if _storage._graphDir != rhs_storage._graphDir {return false}
        if _storage._numSelectFeatures != rhs_storage._numSelectFeatures {return false}
        if _storage._numClassesToTrack != rhs_storage._numClassesToTrack {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
