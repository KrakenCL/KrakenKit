...
extension A_B_C_TestEnum: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [A_B_C_TestEnum] = [
    .default,
    .a,
    .b,
    .c,
...
public struct A_B_C_TestMessage {
  ...
  public mutating func clearOptionalMsg() {_uniqueStorage()._optionalMsg = nil}
  ...
  public mutating func clearNestedMessage() {_uniqueStorage()._nestedMessage = nil}
...
extension A_B_C_TestMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: A_B_C_TestMessage, rhs: A_B_C_TestMessage) -> Bool {
...
extension A_B_C_TestMessage.NestedMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: A_B_C_TestMessage.NestedMessage, rhs: A_B_C_TestMessage.NestedMessage) -> Bool {
